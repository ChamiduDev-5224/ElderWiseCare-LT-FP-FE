...
const CareTakerService: React.FC = () => {
    ...
    const handleCardClick = (card: any, gigId: number) => {
        ...
        <div>
            ...
            <div className="container mx-auto px-4 py-20">
                    ...
                    <div className="bg-slate-100 shadow-lg rounded-lg p-6">
                        ...
                        <div className='flex flex-row bg-white rounded-md p-4 justify-between'>
                            <div>
                                ...
                                <p className="text-gray-500 mt-2">{selectedCard.services.map(service => service.des).join(', ')}</p>
                            </div>
                ...
                <ChatPopup
                    ...
                    caregiverId={selectedUserInfo[0]?.userId}
                />
            </div>
        </div>
    );
