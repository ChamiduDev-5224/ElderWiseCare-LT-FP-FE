                ...
                (
                    <div className="flex flex-row justify-between">
                        <div className="flex flex-col w-[100%] md:w-[50%] lg:w-[40%] px-16 py-10 z-[900]">
                            ...
                            <button className='mt-6 bg-dark-green text-light-green rounded-md py-3 hover:drop-shadow-xl' onClick={onCreateAccount}>Login</button>
                            <button className='mt-6 bg-light-green text-gray-800 rounded-md py-3 flex flex-row items-center justify-center gap-3 hover:drop-shadow-lg'><img src={google} className='w-8 h-8' alt="google" /> Google</button>
                            <p className='mt-2 text-sm text-slate-500 font-normal'>Don't have an account?
                                <Link to="/signup"> <strong className='underline cursor-pointer hover:text-slate-700 active:text-slate-600'> Register</strong></Link>
                            </p>
                        </div>
                        <div className='md:flex flex-row bg-dark-green h-fit w-[60%] justify-end hidden'>
                            ...
                            <img src={loginImg} alt="signup image" className='h-screen rounded-3xl text-right flex-shrink' style={{
